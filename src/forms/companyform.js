...
const Address = require('@uktrade/trade_elements_react/components/address.component')
...
const DidYouMeanCompany = require('@uktrade/trade_elements_react/components/didyoumeancompany.component')
const Radio = require('@uktrade/trade_elements_react/components/radio.component')
const SectorSelect = require('@uktrade/trade_elements_react/components/sectorselect.component')
    ...
    return (
      <div>
        ...
        <div className='button-bar'>
          ...
          { this.state.edit ? <a
            href={`/company/${source}/${sourceId}`}
            className='button-link button--cancel js-button-cancel'>Cancel</a>
